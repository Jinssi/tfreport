...
SYSTEM_PROMPT = (
    ...
    "Given a structured JSON summary of the plan, especially the admin_summary block, "
    "write a concise narrative (max ~12 lines, plain Markdown, no headings) covering: "
    "(1) what is changing in operational terms, "
    "(2) what the approver should review first, "
    "(3) suggested manual checks before merge. "
    "Use the deterministic executive summary as the source of truth and only add concise reviewer guidance. "
    "Be specific to the resources listed. Do not invent resources. "
    "Do not repeat raw counts or restate the stats table unless they change the recommendation. Output only the narrative text."
)
